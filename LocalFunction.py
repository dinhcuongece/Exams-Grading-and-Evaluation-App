...
def stackImages(imgArray: object, scale: object, lables: object = []) -> object:
    rows = len(imgArray)
    cols = len(imgArray[0])
    ...
    if len(lables) != 0:
        ...
        for d in range(0, rows):
            for c in range (0,cols):
                ...
                cv2.putText(ver,lables[d][c],(eachImgWidth*c+10,eachImgHeight*d+20),cv2.FONT_HERSHEY_COMPLEX,0.7,(25,25,25),2)
    return ver
